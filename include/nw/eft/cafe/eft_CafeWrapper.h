...
public:
    ...
    enum
    {
        PRIM_TYPE_POINTS            = GX2_PRIMITIVE_POINTS,
...
public:
    ...
    bool Initialize(TextureFilterMode textureFilter, TextureWrapMode wrapModeU, TextureWrapMode wrapModeV);
...
public:
    ...
    void SetVertexBuffer(void* buf, u32 size, u32 element);
...
public:
    ...
    void BindUniformBlock(const void* param, s32 size = -1);
