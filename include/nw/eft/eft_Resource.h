...
static_assert(sizeof(ResourceEmitterSet) == 0x34, "nw::eft::ResourceEmitterSet size mismatch");

class Resource
{
public:
    Resource() { }
    Resource(Heap* heap, void* bin, u32 resourceID, System* eftSys, bool delayCompile = false);
    ...
    {
        return mResEmitterSet[emitterSetID].tblData[emitterID].emitterResource;
    }

    EmitterStaticUniformBlock* GetEmitterStaticUBO(s32 emitterSetID, s32 emitterID) const
    {
        return mResEmitterSet[emitterSetID].tblData[emitterID].staticUniformBlock;
    }

    EmitterStaticUniformBlock* GetChildEmitterStaticUBO(s32 emitterSetID, s32 emitterID) const
    {
        return mResEmitterSet[emitterSetID].tblData[emitterID].childStaticUniformBlock;
    }
    ...
    {
        return mResEmitterSet[emitterSetID].tblData[emitterID].emitterResource->name;
    }
    ...
    {
        return mResEmitterSet[emitterSetID].tblDataROM[emitterID].emitterResource;
    }
    ...
    {
        return mResEmitterSet[emitterSetID].tblDataROM[emitterID].emitterResource->name;
    }
    ...
    void Initialize(Heap* heap, void* bin, u32 resourceID, System* eftSys, bool delayCompile = false);
...
private:
    ...
    u32                         mPrimitiveNum;
    EmitterStaticUniformBlock*  mEmitterStaticUbo;
};
static_assert(sizeof(Resource) == 0x34, "nw::eft::Resource size mismatch");
